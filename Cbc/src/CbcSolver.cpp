...
int CbcOrClpRead_mode2 = 1;
extern int CbcOrClpRead_mode;
FILE * CbcOrClpReadCommand2 = stdin;
	     ...
	     CbcSolverUsefulData & parameterData)
{
    ...
    CbcOrClpRead_mode2 = 1;
    CbcOrClpReadCommand2 = stdin;
	  ...
	  signal(SIGINT, signal_handler);
        ...
        ampl_info info;
        {
            ...
            if (argc > 2 && !strcmp(argv[2], "-AMPL")) {
                ...
                if (returnCode)
                    return returnCode;
                CbcOrClpRead_mode2 = 2; // so will start with parameters
...
#define SLACK_PRIORITY 100
			  ...
			  printGeneralMessage(model_,generalPrint);
                    ...
                    case CLP_PARAM_ACTION_IMPORT: {
                        ...
                        //sprintf(generalPrint, field.c_str());
                        if (field == "$") {
			      ...
			      printGeneralMessage(model_,generalPrint);
                        ...
                        if (canOpen) {
                            ...
                            if (!status || (status > 0 && allowImportErrors)) {
                                ...
                                if (CbcOrClpRead_mode2 == 2 && argc == 2) {
                                    // only if ends .mps
                                    ...
                                    if (find && find[4] == '\0') {
                                        ...
                                        if (fp) {
                                            CbcOrClpReadCommand2 = fp; // Read from that file
                                            CbcOrClpRead_mode2 = -1;
                                        }
                                    }
                                }
